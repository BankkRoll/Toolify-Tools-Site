...
import { Calendar, Code, ExternalLink, FileText, Shield, Users, Zap } from 'lucide-react';
    ...
    <div className='min-h-screen bg-background'>
          ...
          <div className='flex flex-col items-center text-center space-y-4'>
            <div className='flex flex-col items-center gap-3'>
              ...
              <p className='text-muted-foreground'>
                Simple, transparent terms for our privacy-first platform
              </p>
            </div>
      ...
      <div className='container mx-auto px-4 py-8'>
        <div className='max-w-4xl mx-auto'>
          <Card className={cn('relative rounded-3xl mx-auto px-4 py-10 border shadow-sm')}>
            ...
            <CardHeader>
              <CardTitle className='flex items-center gap-2'>
                ...
                Terms of Service for Toolify
              </CardTitle>
              <CardDescription>
                By using Toolify, you agree to these simple and fair terms.
              </CardDescription>
            </CardHeader>
              ...
              <div className='space-y-4'>
                <section>
                  ...
                  <p className='text-muted-foreground leading-relaxed'>
                    By accessing and using Toolify, you accept and agree to be bound by these Terms
                    of Service. If you do not agree to these terms, please do not use our platform.
                    These terms apply to all visitors, users, and others who access or use Toolify.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className='text-muted-foreground leading-relaxed'>
                    Toolify is a comprehensive collection of browser-based developer tools designed
                    to enhance productivity for developers, designers, and content creators. Our
                    platform provides tools for text manipulation, image processing, PDF operations,
                    data conversion, and more. All processing occurs locally in your browser - no
                    files are uploaded to our servers.
                  </p>
                </section>
                ...
                <section>
                  <h3 className='text-lg font-semibold mb-3'>3. No User Accounts Required</h3>
                  <p className='text-muted-foreground leading-relaxed'>
                    Toolify operates without user accounts or registration. You can use all our
                    tools immediately without creating an account, providing personal information,
                    or logging in. This design choice prioritizes privacy and accessibility while
                ...
                <section>
                  <h3 className='text-lg font-semibold mb-3'>4. Local Data Storage</h3>
                  <p className='text-muted-foreground leading-relaxed mb-3'>
                    Toolify uses your browser's local storage to enhance your experience. This may
                    include:
                  </p>
                  <ul className='space-y-2 text-muted-foreground'>
                    <li className='flex items-start gap-2'>
                      <span className='w-1.5 h-1.5 bg-muted-foreground rounded-full mt-2 flex-shrink-0' />
                      Favorite tools and preferences
                    </li>
                    <li className='flex items-start gap-2'>
                      <span className='w-1.5 h-1.5 bg-muted-foreground rounded-full mt-2 flex-shrink-0' />
                    ...
                    <li className='flex items-start gap-2'>
                      <span className='w-1.5 h-1.5 bg-muted-foreground rounded-full mt-2 flex-shrink-0' />
                      Tool usage history for your convenience
                    </li>
                  </ul>
                  <p className='text-muted-foreground leading-relaxed mt-3'>
                    All this data remains on your device and can be cleared at any time through your
                    browser settings.
                  </p>
                </section>
                ...
                <section>
                  <h3 className='text-lg font-semibold mb-3'>5. File Processing and Privacy</h3>
                  <p className='text-muted-foreground leading-relaxed'>
                    When you use our file processing tools, all operations occur entirely in your
                    browser. Your files are never uploaded to our servers, stored in our databases,
                    or transmitted to third parties. The processed results are generated locally and
                    can be downloaded directly to your device. This ensures complete privacy and
                ...
                <section>
                  <h3 className='text-lg font-semibold mb-3'>6. Acceptable Use</h3>
                  <p className='text-muted-foreground mb-3'>
                    You agree to use Toolify only for lawful purposes and in accordance with these
                ...
                <section>
                  ...
                  <p className='text-muted-foreground leading-relaxed'>
                    Toolify is open-source software. The platform, including its design,
                    functionality, and underlying code, is protected by intellectual property laws.
                    You retain ownership of any content you process through our tools. We do not
                    claim ownership of your files, data, or processed results.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className='text-muted-foreground leading-relaxed'>
                    We strive to maintain high availability of Toolify, but we do not guarantee
                    uninterrupted access. The service may be temporarily unavailable due to
                    maintenance, updates, or technical issues. Since all processing occurs locally,
                    many tools will continue to function even if our website is temporarily
                    unavailable.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className='text-muted-foreground leading-relaxed mb-3'>
                    Toolify is provided "as is" without warranties of any kind. We disclaim all
                  ...
                  <ul className='space-y-2 text-muted-foreground'>
                    ...
                    <li className='flex items-start gap-2'>
                      <span className='w-1.5 h-1.5 bg-muted-foreground rounded-full mt-2 flex-shrink-0' />
                      Warranties regarding the accuracy or reliability of tool outputs
                    </li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  <p className='text-muted-foreground leading-relaxed'>
                    In no event shall Toolify, its developers, or contributors be liable for any
                    indirect, incidental, special, consequential, or punitive damages arising from
                    your use of the service. This includes but is not limited to data loss, business
                    interruption, or any other damages resulting from the use or inability to use
                    our tools.
                  </p>
                </section>
                ...
                <section>
                  <h3 className='text-lg font-semibold mb-3'>11. Third-Party Services</h3>
                  <p className='text-muted-foreground leading-relaxed'>
                    Toolify may use third-party services for analytics, content delivery, and
                    hosting. These services have their own terms of service and privacy policies. We
                    are not responsible for the practices of these third-party services, but we
                    choose them carefully to maintain our privacy standards.
                  </p>
                </section>
                ...
                <section>
                  <h3 className='text-lg font-semibold mb-3'>12. International Use</h3>
                  <p className='text-muted-foreground leading-relaxed'>
                    Toolify is accessible worldwide. By using our service, you agree to comply with
                    all applicable local laws and regulations. Since we don't collect or store
                    personal data, international data transfer regulations don't apply to our
                    service.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className='text-muted-foreground leading-relaxed'>
                    ...
                    be effective immediately upon posting on this page. Your continued use of
                    Toolify after changes constitutes acceptance of the updated terms. We encourage
                ...
                <section>
                  <h3 className='text-lg font-semibold mb-3'>14. Termination</h3>
                  <p className='text-muted-foreground leading-relaxed'>
                    You may stop using Toolify at any time. Since we don't maintain user accounts,
                    there's no formal termination process. Simply stop accessing our website, and
                    clear any local storage data if desired. We may discontinue the service at any
                ...
                <section>
                  <h3 className='text-lg font-semibold mb-3'>15. Governing Law</h3>
                  <p className='text-muted-foreground leading-relaxed'>
                    These Terms of Service are governed by and construed in accordance with
                    applicable laws. Any disputes arising from these terms or your use of Toolify
                ...
                <section>
                  ...
                  <p className='text-muted-foreground leading-relaxed'>
                    If you have questions about these Terms of Service or need to report issues,
                    please contact us through our GitHub repository. We're committed to transparency
                    and will respond to all legitimate inquiries.
                  </p>
                </section>
              </div>
            </CardContent>
          ...
          <div className='flex flex-col sm:flex-row items-center justify-center gap-4 mt-12 pt-8 border-t'>
            <div className='flex items-center gap-2 text-sm text-muted-foreground'>
              ...
              <span>Questions about our terms? We're here to help</span>
            </div>
