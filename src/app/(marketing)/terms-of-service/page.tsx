              ...
              <div className="space-y-4">
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    By accessing and using Toolify, you accept and agree to be
                    bound by these Terms of Service. If you do not agree to
                    these terms, please do not use our platform. These terms
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Toolify is a comprehensive collection of browser-based
                    developer tools designed to enhance productivity for
                    developers, designers, and content creators. Our platform
                    provides tools for text manipulation, image processing, PDF
                    operations, data conversion, and more. All processing occurs
                    locally in your browser - no files are uploaded to our
                    servers.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Toolify operates without user accounts or registration. You
                    can use all our tools immediately without creating an
                    account, providing personal information, or logging in. This
                    design choice prioritizes privacy and accessibility while
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-3">
                    Toolify uses your browser's local storage to enhance your
                  ...
                  <p className="text-muted-foreground leading-relaxed mt-3">
                    All this data remains on your device and can be cleared at
                ...
                <section>
                  <h3 className="text-lg font-semibold mb-3">
                    5. File Processing and Privacy
                  </h3>
                  <p className="text-muted-foreground leading-relaxed">
                    When you use our file processing tools, all operations occur
                    entirely in your browser. Your files are never uploaded to
                    our servers, stored in our databases, or transmitted to
                    third parties. The processed results are generated locally
                    and can be downloaded directly to your device. This ensures
                ...
                <section>
                  ...
                  <p className="text-muted-foreground mb-3">
                    You agree to use Toolify only for lawful purposes and in
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Toolify is open-source software. The platform, including its
                    design, functionality, and underlying code, is protected by
                    intellectual property laws. You retain ownership of any
                    content you process through our tools. We do not claim
                    ownership of your files, data, or processed results.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    We strive to maintain high availability of Toolify, but we
                    do not guarantee uninterrupted access. The service may be
                    temporarily unavailable due to maintenance, updates, or
                    technical issues. Since all processing occurs locally, many
                    tools will continue to function even if our website is
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-3">
                    Toolify is provided "as is" without warranties of any kind.
                  ...
                  <ul className="space-y-2 text-muted-foreground">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-muted-foreground rounded-full mt-2 flex-shrink-0" />
                      Warranties that the service will be error-free or
                      uninterrupted
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-muted-foreground rounded-full mt-2 flex-shrink-0" />
                      Warranties regarding the accuracy or reliability of tool
                      outputs
                    </li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    In no event shall Toolify, its developers, or contributors
                    be liable for any indirect, incidental, special,
                    consequential, or punitive damages arising from your use of
                    the service. This includes but is not limited to data loss,
                    business interruption, or any other damages resulting from
                    the use or inability to use our tools.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Toolify may use third-party services for analytics, content
                    delivery, and hosting. These services have their own terms
                    of service and privacy policies. We are not responsible for
                    the practices of these third-party services, but we choose
                    them carefully to maintain our privacy standards.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Toolify is accessible worldwide. By using our service, you
                    agree to comply with all applicable local laws and
                    regulations. Since we don't collect or store personal data,
                    international data transfer regulations don't apply to our
                    service.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    this page. Your continued use of Toolify after changes
                    constitutes acceptance of the updated terms. We encourage
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    You may stop using Toolify at any time. Since we don't
                    maintain user accounts, there's no formal termination
                    process. Simply stop accessing our website, and clear any
                    local storage data if desired. We may discontinue the
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    these terms or your use of Toolify will be resolved through
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    to report issues, please contact us through our GitHub
                    repository. We're committed to transparency and will respond
                    to all legitimate inquiries.
                  </p>
                </section>
              </div>
            </CardContent>
