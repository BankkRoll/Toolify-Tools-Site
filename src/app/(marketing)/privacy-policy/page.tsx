          ...
          <div className="flex flex-col items-center text-center space-y-4">
            <div className="flex flex-col items-center gap-3">
              ...
              <p className="text-muted-foreground">
                Your privacy is our priority - we don't collect or store your
                data
              </p>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <CardHeader>
              ...
              <CardDescription>
                A comprehensive guide to how we handle your data (spoiler: we
                don't collect any)
              </CardDescription>
            </CardHeader>
              ...
              <div className="space-y-4">
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    At Toolify, we believe privacy is a fundamental human right.
                    Our platform is designed with privacy-first principles,
                    ensuring that your data never leaves your device unless you
                    explicitly choose to share it. We don't have user accounts,
                    we don't store your files, and we don't track your
                    activities.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-3">
                    Unlike many web applications, Toolify operates entirely in
                    your browser. We do not collect:
                  </p>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-3">
                    We use anonymous analytics to understand how our tools are
                    used and improve the user experience. This data is
                    completely anonymous and includes:
                  </p>
                  <ul className="space-y-2 text-muted-foreground">
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-muted-foreground rounded-full mt-2 flex-shrink-0" />
                    ...
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-muted-foreground rounded-full mt-2 flex-shrink-0" />
                      Geographic region (country level only, no specific
                      location)
                    </li>
                  </ul>
                  <p className="text-muted-foreground leading-relaxed mt-3">
                    This analytics data is processed by third-party services
                    (like Google Analytics) and cannot be used to identify
                    individual users.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-3">
                    ...
                    experience. This data stays on your device and includes:
                  </p>
                  <ul className="space-y-2 text-muted-foreground">
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-muted-foreground rounded-full mt-2 flex-shrink-0" />
                  ...
                  <p className="text-muted-foreground leading-relaxed mt-3">
                    ...
                    settings, and it will never be transmitted to our servers.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    When you use our file processing tools (image compression,
                    PDF manipulation, etc.), all processing happens entirely in
                    your browser. Your files are never uploaded to our servers
                    or stored anywhere. The processed results are generated
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-3">
                    We use a limited number of third-party services for
                    essential functionality:
                  </p>
                  <ul className="space-y-2 text-muted-foreground">
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-muted-foreground rounded-full mt-2 flex-shrink-0" />
                      <strong>Analytics providers:</strong> For anonymous usage
                      statistics
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-muted-foreground rounded-full mt-2 flex-shrink-0" />
                    ...
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-muted-foreground rounded-full mt-2 flex-shrink-0" />
                      <strong>Hosting platforms:</strong> For website
                      availability
                    </li>
                  </ul>
                  <p className="text-muted-foreground leading-relaxed mt-3">
                    These services have their own privacy policies, but they
                    cannot access your personal data or the files you process
                    through our tools.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-3">
                    Since we don't collect personal data, you have complete
                  ...
                  <ul className="space-y-2 text-muted-foreground">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-muted-foreground rounded-full mt-2 flex-shrink-0" />
                      Disable analytics tracking through browser privacy
                      settings
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-muted-foreground rounded-full mt-2 flex-shrink-0" />
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Since we don't store your data on our servers, the security
                    of your information depends entirely on your device and
                    browser. We implement best practices for client-side
                    security, including HTTPS encryption for all communications
                    and secure coding practices to protect against client-side
                    vulnerabilities.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Toolify is designed for professional use and does not
                    knowingly collect personal information from children under
                    13. Since we don't collect personal data from anyone, this
                    policy applies to all users regardless of age.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Toolify is accessible worldwide, but since we don't collect
                    or process personal data, international data transfer
                    regulations don't apply to our service. Your data remains on
                    your local device regardless of your location.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    practices or for legal compliance. Since we don't collect
                    personal data, we won't need to notify you of changes, but
                    we will update the "Last updated" date on this page.
                    Continued use of Toolify after changes constitutes
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    privacy practices, you can contact us through our GitHub
                    repository. We're committed to transparency and will respond
                    to all legitimate privacy-related inquiries.
                  </p>
                </section>
              </div>
            </CardContent>
