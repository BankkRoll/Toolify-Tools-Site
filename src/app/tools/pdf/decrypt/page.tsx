...
export default function DecryptPdfPage() {
  ...
  const [history, setHistory] = useLocalStorage<string[]>('pdf-decrypt-history', []);
        ...
        >
          ...
          {selectedFile && isEncrypted && (
            <MotionDiv
              ...
              initial={animationsEnabled ? 'hidden' : undefined}
              animate={
                animationsEnabled ? (passwordSectionInView ? 'visible' : 'hidden') : undefined
              }
            >
              <Card>
                <CardHeader>
                  <CardTitle>Enter Password</CardTitle>
                  <CardDescription>Provide the password to decrypt the PDF</CardDescription>
                </CardHeader>
          ...
          <Card>
            <CardHeader>
              <CardTitle className='flex items-center justify-between'>
                Decrypted PDF
                {decryptedPdf && (
                  <Button variant='outline' size='sm' onClick={downloadDecryptedPdf}>
              ...
              {decryptedPdf ? (
                ...
                >
                  <div className='text-center'>
                    ...
                    <p className='text-sm font-medium'>PDF Decrypted Successfully</p>
                    <p className='text-xs text-muted-foreground'>Password protection removed</p>
                  </div>
                </MotionDiv>
              ) : isEncrypted === false ? (
                <MotionDiv
                ...
                <div className='flex items-center justify-center h-32 border-2 border-dashed rounded-lg'>
                  <p className='text-muted-foreground'>Decrypted PDF will appear here</p>
                </div>
              )}
            </CardContent>
          </Card>
