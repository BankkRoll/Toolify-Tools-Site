...
export default function PdfToImagePage() {
  ...
  const [history, setHistory] = useLocalStorage<string[]>('pdf-to-image-history', []);
    ...
    try {
      ...
      for (let i = 0; i < pageCount; i++) {
        ...
        if (ctx) {
          ...
          ctx.fillText('(Image conversion placeholder)', canvas.width / 2, canvas.height / 2 + 40);
        }
          ...
          >
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure image output format and quality</CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                <CardTitle className='flex items-center justify-between'>
                  Converted Images
                  <ActionButtons onDownload={downloadAllImages} variant='outline' size='sm' />
                </CardTitle>
                <CardDescription>
