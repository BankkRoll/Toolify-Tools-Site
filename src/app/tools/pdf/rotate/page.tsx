...
export default function RotatePdfPage() {
  ...
  const [history, setHistory] = useLocalStorage<string[]>('pdf-rotate-history', []);
  ...
  const rotatePdf = async () => {
    ...
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : 'Failed to rotate PDF';
        ...
        >
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure rotation angle and page range</CardDescription>
            </CardHeader>
          ...
          >
            <Card>
              <CardHeader>
                ...
                <CardDescription>Your rotated PDF is ready for download</CardDescription>
              </CardHeader>
              <CardContent>
                <ActionButtons
