...
export default function JwtDebuggerPage() {
  ...
  const [history, setHistory] = useLocalStorage<string[]>('jwt-debugger-history', []);
  ...
  const decodeJWT = () => {
    ...
    try {
      ...
      setIsComplete(true);
      setHistory([`JWT decoded: ${jwtToken.substring(0, 20)}...`, ...history].slice(0, 10));
                      ...
                      <div className='grid grid-cols-1 md:grid-cols-2 gap-4 text-sm'>
                        ...
                        {decodedJwt.payload.exp && (
                          <div className='flex justify-between'>
                            ...
                            <span
                              className={isExpired(decodedJwt.payload.exp) ? 'text-red-500' : ''}
                            >
                  ...
                  <TabsContent value='signature' className='space-y-4'>
                    <div className='space-y-2'>
                      ...
                      <div className='p-3 bg-muted rounded-lg'>
                        <p className='font-mono text-sm break-all'>{decodedJwt.signature}</p>
                      </div>
                    </div>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4 text-sm'>
                ...
                >
                  ...
                  <p className='text-muted-foreground'>
                    ...
                    transferred between two parties. They are commonly used for authentication and
