...
export default function ColorConverterPage() {
  ...
  const [inputColor, setInputColor] = useLocalStorage('color-converter-input', '');
  const [inputFormat, setInputFormat] = useLocalStorage('color-converter-input-format', 'hex');
    ...
    try {
      switch (format) {
        ...
        case 'hsl':
          ...
          return hslMatch
            ? hslToRgb(parseInt(hslMatch[1]), parseInt(hslMatch[2]), parseInt(hslMatch[3]))
            : null;
        default:
          return null;
      }
  ...
  const convertColor = () => {
    ...
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : 'Invalid color format';
                    ...
                    <div className='flex items-center justify-between text-sm'>
                      <div className='flex-1 min-w-0'>
                        <div className='flex items-center gap-2'>
                          ...
                          />
                          <p className='font-medium truncate font-mono'>{entry.color}</p>
