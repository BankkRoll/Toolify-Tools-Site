...
export default function JsonFormatterPage() {
  ...
  const [history, setHistory] = useLocalStorage<string[]>('json-formatter-history', []);
  ...
  const formatJson = () => {
    ...
    try {
      ...
      setIsComplete(true);
      setHistory([`JSON formatted: ${inputJson.substring(0, 20)}...`, ...history].slice(0, 10));
  ...
  const minifyJson = () => {
    ...
    try {
      ...
      setValidationResult({ isValid: true, message: 'Valid JSON' });
      setIsComplete(true);
      setHistory([`JSON minified: ${inputJson.substring(0, 20)}...`, ...history].slice(0, 10));
  ...
  const validateJson = () => {
    ...
    try {
      ...
      setValidationResult({ isValid: true, message: 'Valid JSON' });
      setIsComplete(true);
      setHistory([`JSON validated: ${inputJson.substring(0, 20)}...`, ...history].slice(0, 10));
        ...
        >
          <Card>
            <CardHeader>
              ...
              <CardDescription>Enter JSON data or upload a JSON file</CardDescription>
            </CardHeader>
            ...
            <CardContent className='space-y-4'>
              {outputJson ? (
                ...
                <div className='flex items-center justify-center h-32 border-2 border-dashed rounded-lg'>
                  <p className='text-muted-foreground'>Enter JSON and click format to see output</p>
                </div>
              )}
            </CardContent>
          </Card>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4 text-sm'>
                ...
                >
                  ...
                  <p className='text-muted-foreground'>
                    JSON formatting adds proper indentation and spacing to make JSON data more
                    readable. This is useful for debugging, documentation, and human-readable data
                    storage.
                  </p>
                </MotionDiv>
                <MotionDiv
                ...
                >
                  ...
                  <p className='text-muted-foreground'>
                    JSON minification removes all unnecessary whitespace to reduce file size. This
                    is essential for production environments where bandwidth and storage efficiency
                    matter.
                  </p>
                </MotionDiv>
              </div>
