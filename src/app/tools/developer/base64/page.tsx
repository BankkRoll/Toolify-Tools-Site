...
export default function Base64EncoderPage() {
  ...
  const encodeText = () => {
    ...
    try {
      ...
      setError(null);
      setIsComplete(true);
      setHistory([`Text encoded: ${inputText.substring(0, 20)}...`, ...history].slice(0, 10));
  ...
  const decodeText = () => {
    ...
    try {
      ...
      setError(null);
      setIsComplete(true);
      setHistory([`Text decoded: ${decoded.substring(0, 20)}...`, ...history].slice(0, 10));
  ...
  return (
    <ToolLayout toolId='dev-base64'>
      ...
      >
        {/* Main Content */}
        <MotionDiv ref={textSectionRef} variants={animationsEnabled ? cardVariants : undefined}>
          <Card className='shadow-md border-0 overflow-hidden'>
              ...
              <div className='flex flex-col space-y-4 sm:hidden'>
                ...
                <div className='flex items-center justify-between'>
                  <ActionButtons
                    ...
                    variant='outline'
                    size='sm'
                    disabled={activeTab === 'text' ? !inputText.trim() : selectedFiles.length === 0}
                  />
                </div>
              </div>
              ...
              <div className='hidden sm:flex items-center justify-between'>
                <div className='flex items-center gap-3'>
                  ...
                  <div>
                    ...
                    <CardDescription>
                      Convert text and files to Base64 encoding or decode Base64 back to original
                      format
                    </CardDescription>
                  </div>
                </div>
                <div className='flex items-center gap-2'>
                  <ActionButtons
                    onGenerate={activeTab === 'text' ? encodeText : encodeFile}
                    generateLabel={activeTab === 'text' ? 'Encode' : 'Encode File'}
                    onReset={activeTab === 'text' ? decodeText : decodeFile}
            ...
            <CardContent className='p-4 sm:p-6 pt-0 sm:pt-0'>
              <Tabs value={activeTab} onValueChange={setActiveTab} className='w-full'>
                    ...
                    <div className='space-y-3 sm:space-y-4'>
                      <div className='space-y-2'>
                        ...
                        <div className='flex items-center justify-between text-xs text-muted-foreground'>
                          ...
                          {inputText && (
                            <Badge
                              variant={isValidBase64(inputText) ? 'default' : 'secondary'}
                              className='text-xs'
                            >
                              {isValidBase64(inputText) ? 'Valid Base64' : 'Plain Text'}
                            </Badge>
                          )}
                        </div>
                      </div>
                          ...
                          >
                            ...
                            <div className='flex items-center justify-between text-xs text-muted-foreground'>
                              ...
                              <Badge variant='outline' className='text-xs'>
                                {isValidBase64(outputText) ? 'Base64' : 'Decoded'}
                              </Badge>
                            </div>
                ...
                <TabsContent value='file' className='space-y-4 sm:space-y-6 mt-0'>
                  <div className='grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6'>
                    {/* File Upload Section */}
                    <div className='space-y-3 sm:space-y-4'>
                      <div className='space-y-2'>
        ...
        {/* About Section */}
        <MotionDiv ref={aboutRef} variants={animationsEnabled ? cardVariants : undefined}>
          <Card className='shadow-md border-0 overflow-hidden'>
            <CardHeader className='p-4 sm:p-6 pb-4 sm:pb-6'>
              <CardTitle className='flex items-center gap-2 text-lg sm:text-xl'>
            ...
            <CardContent className='p-4 sm:p-6 pt-0 sm:pt-0'>
              <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 text-sm'>
                ...
                >
                  <h4 className='font-semibold mb-3 text-primary'>What is Base64?</h4>
                  <p className='text-muted-foreground leading-relaxed text-sm sm:text-base'>
                    Base64 is a binary-to-text encoding scheme that represents binary data in an
                    ASCII string format. It's commonly used for transmitting data over text-based
                    protocols like HTTP, email, and JSON.
                  </p>
                </MotionDiv>
                <MotionDiv
                  initial={animationsEnabled ? { opacity: 0, x: 20 } : undefined}
                ...
                >
                  <h4 className='font-semibold mb-3 text-primary'>Common Uses</h4>
