...
export default function CronDecoderPage() {
  ...
  const [cronExpression, setCronExpression] = useLocalStorage(
    "cron-decoder-expression",
    "",
  );
    ...
    try {
      ...
      const errorMessage =
        error instanceof Error
          ? error.message
          : "Failed to decode cron expression";
        ...
        >
          <div className="space-y-2">
            ...
            <p className="text-sm text-gray-500">
              Enter a valid cron expression with 5 parts: minute hour day month
              weekday
            </p>
          </div>
