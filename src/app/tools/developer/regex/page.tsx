...
export default function RegexTesterPage() {
  ...
  const [history, setHistory] = useLocalStorage<string[]>('regex-tester-history', []);
  ...
  const testRegex = () => {
    ...
    try {
      ...
      setMatches(matches);
      setIsComplete(true);
      setHistory([`Regex tested: ${pattern} (${matches.length} matches)`, ...history].slice(0, 10));
        ...
        >
          <Card>
            <CardHeader>
              ...
              <CardDescription>Enter a regex pattern and test text to find matches</CardDescription>
            </CardHeader>
        ...
        >
          <Card>
            <CardHeader>
              ...
              <CardDescription>Matches found and highlighted text</CardDescription>
            </CardHeader>
              ...
              <Tabs defaultValue='matches' className='w-full'>
                ...
                <TabsContent value='highlighted' className='space-y-4'>
                  {matches.length > 0 ? (
                    ...
                    <div className='flex items-center justify-center h-32 border-2 border-dashed rounded-lg'>
                      <p className='text-muted-foreground'>No matches to highlight</p>
                    </div>
                  )}
                </TabsContent>
              </Tabs>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4 text-sm'>
                ...
                >
                  ...
                  <p className='text-muted-foreground'>
                    ...
                    strings. They are powerful tools for text processing, validation, and search
                    operations.
                  </p>
                </MotionDiv>
                <MotionDiv
