...
export default function CssMinifierPage() {
  ...
  const [minifyLevel, setMinifyLevel] = useLocalStorage('css-minifier-level', 'basic');
  ...
  const minifyCssInput = () => {
    ...
    try {
      ...
      // Add to history
      const newEntry = {
        input: inputCss.length > 100 ? inputCss.substring(0, 100) + '...' : inputCss,
      ...
      const errorMessage = error instanceof Error ? error.message : 'Failed to minify CSS';
          ...
          <div className='space-y-2'>
            ...
            <Select value={minifyLevel} onValueChange={setMinifyLevel}>
              ...
              <SelectContent>
                ...
                <SelectItem value='advanced'>Advanced (Remove zeros & shorten colors)</SelectItem>
                <SelectItem value='extreme'>Extreme (Remove prefixes & empty rules)</SelectItem>
              </SelectContent>
            </Select>
          </div>
