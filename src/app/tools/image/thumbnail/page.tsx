...
export default function ImageThumbnailPage() {
  ...
  const [history, setHistory] = useLocalStorage<string[]>('image-thumbnail-history', []);
  ...
  const createThumbnail = async () => {
    ...
    try {
      ...
      img.onload = () => {
        ...
        const thumbnailDataUrl = canvas.toDataURL(mimeType, thumbnailConfig.quality);
  ...
  const downloadThumbnail = () => {
    ...
    const extension = thumbnailConfig.format === 'jpeg' ? 'jpg' : thumbnailConfig.format;
        ...
        >
          <Card>
            <CardHeader>
              ...
              <CardDescription>Select an image to create thumbnail</CardDescription>
            </CardHeader>
            <CardContent>
              <FileUploadZone
          ...
          >
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure thumbnail size and format</CardDescription>
              </CardHeader>
              <CardContent className='space-y-4'>
                ...
                <div className='space-y-2'>
                  <Label>Quality: {Math.round(thumbnailConfig.quality * 100)}%</Label>
                  <input
                    type='range'
                    min='0.1'
                    max='1'
