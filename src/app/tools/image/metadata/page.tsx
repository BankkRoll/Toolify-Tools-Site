                ...
                <Card>
                  ...
                  <CardContent className="space-y-3">
                    <MotionDiv
                      ...
                      transition={
                        animationsEnabled ? { delay: 0.1 } : undefined
                      }
                    >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          ...
                          className="h-6 w-6"
                          onClick={() =>
                            copyToClipboard(metadata.fileName, "File name")
                          }
                        >
                    ...
                    <MotionDiv
                      ...
                      transition={
                        animationsEnabled ? { delay: 0.3 } : undefined
                      }
                    >
                      <span className="text-sm text-muted-foreground">
                        File Type
                    ...
                    <MotionDiv
                      ...
                      transition={
                        animationsEnabled ? { delay: 0.4 } : undefined
                      }
                    >
                      <span className="text-sm text-muted-foreground">
                        Dimensions
                    ...
                    <MotionDiv
                      ...
                      transition={
                        animationsEnabled ? { delay: 0.5 } : undefined
                      }
                    >
                      <span className="text-sm text-muted-foreground">
                        Aspect Ratio
                    ...
                    <MotionDiv
                      ...
                      transition={
                        animationsEnabled ? { delay: 0.6 } : undefined
                      }
                    >
                      <span className="text-sm text-muted-foreground">
                        Last Modified
                      ...
                      <CardContent className="space-y-3">
                        ...
                        {metadata.exif.flash && (
                          <MotionDiv
                            ...
                            transition={
                              animationsEnabled ? { delay: 0.7 } : undefined
                            }
                          >
                            <span className="text-sm text-muted-foreground">
                              Flash
                        ...
                        {metadata.exif.whiteBalance && (
                          <MotionDiv
                            ...
                            transition={
                              animationsEnabled ? { delay: 0.8 } : undefined
                            }
                          >
                            <span className="text-sm text-muted-foreground">
                              White Balance
