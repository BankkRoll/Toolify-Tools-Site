...
import { getAllActiveTools, getToolsByCategory, toolCategories } from '@/lib/tools-config';
    ...
    <Sidebar variant='sidebar' className='border-r overflow-hidden'>
      ...
      <SidebarContent className='overflow-hidden'>
        ...
        <SidebarGroup>
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton asChild isActive={pathname === '/tools'} className='justify-start'>
                <Link href='/tools'>
                  <Grid3X3 />
                  <span>All Tools</span>
