...
export function CallToAction() {
  ...
  return (
    <MotionSection
      ...
      animate={animationsEnabled ? (featuresInView ? 'visible' : 'hidden') : undefined}
      ...
      <div className='mx-auto flex max-w-7xl flex-col items-center px-6 lg:px-8'>
        ...
        >
          ...
          >
            ...
            <h3 className='mt-6 text-xl font-semibold text-foreground'>Lightning Fast</h3>
            <p className='mt-4 text-muted-foreground'>
              All tools run directly in your browser with optimized performance and instant results.
            </p>
          </MotionDiv>
          <MotionDiv
            variants={animationsEnabled ? itemVariants : undefined}
          ...
          >
            ...
            <h3 className='mt-6 text-xl font-semibold text-foreground'>Privacy First</h3>
            <p className='mt-4 text-muted-foreground'>
          ...
          >
            ...
            <h3 className='mt-6 text-xl font-semibold text-foreground'>Always Available</h3>
            <p className='mt-4 text-muted-foreground'>
              No downloads or installations required. Access your tools from anywhere, anytime.
            </p>
          </MotionDiv>
        </MotionDiv>
      </div>
